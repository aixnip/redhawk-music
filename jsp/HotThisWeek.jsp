...
<%! String title = "RedHawk Music - Hot This Week";%>
		...
		<div class="grid">
			...
			<ul class="image-grid">
				...
				for (int i=0; i<songs.size(); i++)
				{
					...
					if ((ifdatemonth.before(itemadded) == true) && (songs.get(i).getRatings() == 5))
					{
					%>
					<li>
			...
			<ul class="image-grid">
				...
				for (int i=0; i<albums.size(); i++)
				{
					...
					if ((ifdatemonth.before(itemadded) == true) && (albums.get(i).getRatings() == 5))
					{
					%>
					<li>
			...
			<ul class="image-grid">
				...
				for (int i=0; i<videos.size(); i++)
				{
					...
					if ((ifdatemonth.before(itemadded) == true) && (videos.get(i).getRatings() == 5))
					{
					%>
					<li>
