...
<%! String title = "RedHawk Music - Recommendations";%>
...
<%-- Begin Content --%>
		...
		<div class="grid">
			<h2><a href="TopRSongs.jsp">Top Recommended Songs</a></h2>
			<ul class="image-grid">
				<%
				for (int i=0; i<4; i++)
				{
			...
			<h2><a href="TopRVideos.jsp">Top Recommended  Videos</a></h2>
			<ul class="image-grid">
				<%
				for (int i=0; i<4; i++)
				{
			...
			<h2><a href="TopRAlbums.jsp">Top Recommended  Albums</a></h2>
			<ul class="image-grid">
				<%
				for (int i=0; i<4; i++)
				{
